Feature: New, More Powerful Laser Checkout System
  ...
  Clint, the nightshift manager has too many lavendar hearts and wants to get encourage customers to buy more 
  by reducing their price to £8.50 when their are two or more in the basket.
